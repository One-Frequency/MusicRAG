  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-center bg-gradient-to-br from-purple-600 to-blue-700 relative overflow-hidden">
          <div className="relative z-10 max-w-md text-center text-white p-8">
            <h3 className="text-3xl font-bold mb-6">
              Join the Future of Music Creation
            </h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span>Advanced AI music composition tools</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                  <svg
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-purple-600/50 to-blue-700/50"></div>
          ...
          <div className="max-w-md w-full space-y-8">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Start your journey with AI-powered music creation
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register('department')}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    placeholder="e.g., Marketing, Music Production"
                  />
                </div>
